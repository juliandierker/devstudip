...
class qtype_algebra_parser_term {
    ...
    var $_arguments=[]; // Array of arguments in class form
...
class qtype_algebra_parser {
     ...
     */
    function parse($text,$variables=[],$undecvars=false) {
