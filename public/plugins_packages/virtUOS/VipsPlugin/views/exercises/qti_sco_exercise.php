...
<assessmentItem xmlns="http://www.imsglobal.org/xsd/imsqti_v2p1" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.imsglobal.org/xsd/imsqti_v2p1.xsd" identifier="SingleChoiceAbstention" title="<?= vips_xml_encode($exercise->title) ?>" adaptive="false" timeDependent="false">
    ...
    <itemBody>
        ...
        <? foreach ($exercise->task as $block => $task) :  /* each block */ ?>
            <choiceInteraction responseIdentifier="RESPONSE<?= $block ?>" shuffle="false" maxChoices="1">
                ...
                <? endforeach ?>
                <simpleChoice identifier="choice-1">
                    <?= _vips("keine Antwort") ?>
                </simpleChoice>
            </choiceInteraction>
        <? endforeach ?>
