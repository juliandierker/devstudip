...
<div>
    <input type="text" class="character_input size-s" name="label_yes" value="<?= htmlReady($exercise->task['choices'][1]) ?>"> /
    <input type="text" class="character_input size-s" name="label_no" value="<?= htmlReady($exercise->task['choices'][0]) ?>"> /
    <?= _vips('keine Antwort') ?>
</div>
